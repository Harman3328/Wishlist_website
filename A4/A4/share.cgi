...
def create(user):
    ...
    print "<thead><tr><td><h3>Username</h3></td><td><h3>Share</h3></td></tr></thead>"
    people = db.A4Users.find({'Username':{'$ne':user}})
    for p in people:
        print "<tr><td>"+p['Username']+"</td><td><button class='button' onclick='share()' id='share."+str(p['_id'])+"'>Share</button></td></tr>"
    print "</table>"
